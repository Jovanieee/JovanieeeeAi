...
monitor.on('up', (res) => console.log(chalk.bold.hex("#00FF00")("[ Jovan ] ❯ ") + chalk.hex("#00FF00")(`${res.website}`)))
...
function startBot(message) {
    ...
    const child = spawn("node", ["--trace-warnings", "--async-stack-traces", "Jovanie.js"], {
        cwd: __dirname,
        stdio: "inherit",
        shell: true
    });
...
axios.get("https://raw.githubusercontent.com/Jovanieeeee/JovanBypass/main/package.json").then((res) => {
...
app.get('/', (req, res) => res.sendFile(__dirname+'/Jovan.html'))